...
parser.add_option('--GMM',        dest='GMMdatafiles', action="append", default=[], help="GMM data files")
...
for f in selected_fret_list:
    ...
    rst=IMP.isd.FretRestraint(rbs[d],GMMter[d],GMMctrs[d],GMMw[d],GMMsig[d],rbs[a],GMMter[a],GMMctrs[a],GMMw[a],GMMsig[a],kda,Ida,Sigma0,Pbl,data,fexp)
    fret_dict[d+"_"+a]=rst
